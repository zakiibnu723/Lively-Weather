    ...
    chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: 'rgba(226, 226, 226, 0.76)',
                lineTension: 0.1,
                borderWidth: 1,
                order: 2,
...
function DisplayDataHour(indexhari, indexjam) {
    ...
    target.onDisplay();
    updateTheme(target.currentTime, target.sunriseTime, target.sunriseTime, target.icon)
}
...
function addHover(evt, index, legend) {
    ...
    dataset.borderColor = 'rgba(226, 226, 226, 0.76)';
    dataset.backgroundColor = 'rgba(96, 96, 96, 0.326)';
    dataset.order = 99;
...
function removeHover(evt, index, legend) {
    ...
    dataset.borderColor = 'rgba(105, 105, 105, 0.175)';
    dataset.backgroundColor = 'rgba(138, 138, 138, 0.050)';
    dataset.order = 0;
